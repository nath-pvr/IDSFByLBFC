        ...
        'taxonomies'        => array('category')
            ...
            $taxoModule = array(
                ...
                "labels"         => array(
                     ...
                     "edit_item"      => "Éditer un Modules",
                     "view_item"      => "Voir les Modules",
                     "update_item"    => "Mettre à jour les Modules",
                     "add_new_item"   => "Ajouter un nouveau Module",
                     "search_item"    => "Rehercher dans les Modules"),
                 "hierarchical"  => true,
                 "show_in_menu"  => true,
                 "show_in_rest"  => true,
...
// add_filter('posts_where', 'idsfTheme_posts_where',10,10);
